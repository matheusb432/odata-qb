...
export type ODataFilterData = ODataFilterValue | ODataFilterOperation | ODataFilterOperation[];
/**
 * @description
 ...
 * }
 */
export type ODataFilterOperation = [ODataFilterType.Raw, string] | [ODataFilterType.NestedFilter, ODataFilter] | [
...
export declare class ODataGuid {
    private _inner;
    get inner(): string;
